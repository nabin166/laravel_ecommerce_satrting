...
<form action="/productadd" class=" flex  justify-center" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class=" flex-row ">
        ...
        <button type="submit"
            class=" w-[300px] font-mono mt-8 bg-sky-700 py-2 px-7 text-center hover:bg-sky-900 rounded-md">Submit</button>
    </div>
